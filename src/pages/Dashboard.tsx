  ...
  const metricCards = [
    {
      ...
      value: `${metrics.totalReceivables.toLocaleString('pt-BR', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`,
    ...
    },
    {
      ...
      value: `${metrics.totalPayables.toLocaleString('pt-BR', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`,
    ...
    },
    {
      ...
      value: `${metrics.balance.toLocaleString('pt-BR', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`,
