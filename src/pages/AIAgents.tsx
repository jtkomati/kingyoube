...
export default function AIAgents() {
  ...
  return (
    <DashboardLayout>
      <div className="relative min-h-[calc(100vh-4rem)] flex flex-col items-center overflow-hidden py-6">
        {/* Gradient Background */}
        ...
        <div className="relative z-10 w-full max-w-4xl px-4 flex flex-col items-center gap-6">
          ...
          {/* Messages area */}
          {messages.length > 0 && (
            <div className="w-full max-h-[40vh] overflow-y-auto space-y-4 scrollbar-thin">
          ...
          {/* Chat Input */}
          <div className="w-full bg-card/80 backdrop-blur-xl rounded-2xl border border-border p-2 mt-auto">
